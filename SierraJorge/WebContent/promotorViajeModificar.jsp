...
<html>
<head>
<title>ShareMyTrip :: Modificar nuevo viaje</title>
...
<body>
	<div class="w3-container w3-blue">
		<h1>Modificar viaje :: ShareMyTrip</h1>
	...
	<div class="w3-row">
		<form id='f' action="verificarModificarViaje" method="post">
			...
			<div class="w3-container w3-third">
				...
				<p>
					...
					<c:if test="${param.coste != null}">
						<input id="coste" name="coste" class="w3-input" type="number"
							min="0" required value="${param.coste}" />
					</c:if>
				</p>
			</div>
	...
	<div class="w3-container">
		<input form="f" type="submit" value="Confirmar"
